...
def build_email_html(day_name, date, week_data, desk_bookings):
    ...
    <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; max-width:600px; margin:0 auto;">
        ...
        <div style="background:#eef2ff; padding:12px 24px; border:1px solid #e5e7eb; border-top:none;">
            <p style="margin:0; font-size:14px; text-align:center;">
                📝 <a href="https://form.jotform.com/260537514417052" style="color:#4338ca; font-weight:700; text-decoration:underline;">Set your NEXT week's schedule with one click</a>
            </p>
        </div>
        <div style="background:#f9fafb; padding:8px 24px; border:1px solid #e5e7eb; border-top:none;">
            <p style="margin:0; font-size:12px; text-align:center; color:#6b7280;">
                Need to make changes for this week? <a href="https://inout-board-fdu78e24bjvyservvvnrax.streamlit.app/" style="color:#6b7280;">Open the dashboard</a> to update your schedule or claim a desk
            </p>
        </div>
